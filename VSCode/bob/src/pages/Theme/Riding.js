    ...
    <div className="riding-container">
      ...
      <div className="photo-box-container">
        ...
        <div className="photo-box-wrapper">
          <div className=".photo-box.box-1" onClick={() => scrollToSection(0)}>
            <img
          ...
          <div className="photo-box.box-2" onClick={() => scrollToSection(1)}>
            <img
          ...
          <div className="photo-box.box-3" onClick={() => scrollToSection(2)}>
            <img
