...
import { getCcCode, getCcLabel } from "../../utils/categoryUtils"; // 카테고리 변환 유틸리티 함수 추가
...
function SignupForm() {
  ...
  const handleChange = (e) => {
    ...
    setErrors((prev) => ({
      ...prev,
      [name]: validateField(name, sanitizedValue, formData),
    }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...formData,
        type: getCcCode(formData.type), // 배기량 변환 (스쿠터 → S)
      };
      ...
      <div className="signup-container">
        ...
        <form onSubmit={handleSubmit}>
          {[
            ...
            ({ name, placeholder, icon, button, onClick, type = "text" }) => (
